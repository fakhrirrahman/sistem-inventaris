    ...
    <div class="min-h-screen flex">
        <div class="w-full md:w-1/2 flex items-center justify-center px-6 py-12 sm:px-8 lg:px-10 bg-white">
            <div class="w-full max-w-md">
                ...
                <button type="button" class="w-full mb-8 py-3 px-4 border border-gray-300 rounded-lg text-gray-700 font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition duration-200">
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600 text-sm">
                        Belum memiliki akun? 
                        <a href="#" class="font-semibold text-cyan-600 hover:text-cyan-700 transition">
                            Buat akun
                        </a>
                    </p>
                </div>
        ...
        <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-cyan-500 to-cyan-600 relative overflow-hidden">
            <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1552664730-d307ca884978?w=1000&q=80');"></div>
            <div class="absolute inset-0 bg-gradient-to-t from-gray-900/60 via-gray-900/30 to-transparent"></div>
            <div class="relative flex items-end justify-center pb-12 text-white text-center px-8">
                <div>
                    <h2 class="text-3xl font-bold mb-3">Selamat Datang</h2>
                    <p class="text-gray-200 text-sm">Kelola inventaris sekolah dengan mudah dan efisien</p>
                </div>
            </div>
        </div>
    </div>
